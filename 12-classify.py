...
subfolder_path = os.path.join(current_dir, '12-others')  
...
if __name__ == '__main__':
    # 加载模型  
    model_path = r'.\12-others\train_logs\resnet18_pretrain_test\version_7\checkpoints\resnet18_pretrain_test-epoch=24-val_loss=0.03.ckpt'
    ...
    test2_dataloader = otherDataset('./12-others/data/aigc')
    test2_dataloader = DataLoader(test2_dataloader, batch_size=128, shuffle=False)
    test3_dataloader = otherDataset('./12-others/data/zaosheng')
